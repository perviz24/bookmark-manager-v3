# ENFORCED BUILD SYSTEM — Bookmark Manager v3
...
```bash
cp .githooks/pre-commit .git/hooks/pre-commit && cp .githooks/commit-msg .git/hooks/commit-msg && chmod +x .git/hooks/pre-commit .git/hooks/commit-msg
```
